...
entry:
  ...
  store i32 0, ptr %file_descriptor, align 1
  %syscall_number = alloca i32, align 1
  store i32 0, ptr %syscall_number, align 1

  %str_input = alloca [4096 x i8], align 2
  store [4096 x i8] zeroinitializer, ptr %str_input, align 2
  %len_output = alloca i32, align 2
  store i32 len %str_input, align 2
